...
// Source: https://codegolf.stackexchange.com/a/22326
// Compilate and run: C:/Windows/Microsoft.NET/Framework/v4.0.30319/csc.exe /out:rainbow-smoke.exe rainbow-smoke.cs && ./rainbow-smoke.exe
...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        var checkpoints = Enumerable.Range(1, CHECKPOINTS).ToDictionary(i => i * colors.Count / CHECKPOINTS - 1, i => i - 1);
        ...
        for (var i = 0; i < colors.Count; i++)
        {
            ...
            if (checkpoints.TryGetValue(i, out chkidx))
            {
                ...
                img.Save("rainbow-smoke-output/rainbow-smoke-" + chkidx + ".png");
            }
        }
